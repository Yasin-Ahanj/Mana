...
const LoginPasscode = () => {
    ...
    const sendMobileNumber = async () => {
        if (passwordRegex.test(password)) {
            const res = await fetch("http://127.0.0.1:8000/api/v1/login-username", {
                method: "POST",
                headers: {
            ...
            <div className="lg:flex  lg:items-center lg:h-[85vh] lg:w-[90%] lg:items-center lg:mt-5 lg:mx-auto  lg:bg-[#F4F4F4] lg:rounded-[20px] lg:overflow-hidden">
                ...
                <div className=" lg:h-[100%]">
                    <div dir="rtl" className="flex w-[80%] mx-auto mt-4 flex-col align-center ">
                        <span className="text-[#000]">ورود به حساب کاربری</span>
                    ...
                    <Link href="/Pages/Login" className=" my-4 lg:my-[8px] block  mx-auto w-[80%] underline text-[#0D18EF] text-right">قبلا ثبت نام کرده اید؟ وارد شوید</Link>
