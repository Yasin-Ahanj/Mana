...
import SkillBox from "@/app/Components/SkillBox/page";
...
interface ApiResponse {
    ...
    status_id: number;
    title: string;
    total_price_absence: number;
    total_price_present: number;
    slug: string;
    created_at: Date;
    updated_at: Date;
    skills: Skill[];
...
const CategorieCourses = () => {
    ...
    const purchaseCourse = () => {
        ...
        if (!token) {
            router.push(`/Pages/Login?from=/Pages/Courses/${id}`);
        } else {
            setOpen(true);
        }
    }
    ...
    const fetchData = async () => {
        try {
            const res = await fetch(
                `http://127.0.0.1:8000/api/v1/get-course-data-by-id/${id}`,
                {
                    method: "GET",
    ...
    return (
        <div>
            ...
            <div dir="rtl" className=" w-[90%] mx-auto mt-4 ">
                {
                    isLoading ? (
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="grid grid-cols-2 gap-4 mt-4 w-[90%] mx-auto justify-between">
                                <Skeleton className=" h-[80px] rounded-[5px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.25)]" />
                                <Skeleton className=" h-[80px] rounded-[5px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.25)]" />
                                <Skeleton className=" h-[80px] rounded-[5px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.25)]" />
                                <Skeleton className=" h-[80px] rounded-[5px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.25)]" />
                                <Skeleton className=" h-[80px] rounded-[5px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.25)]" />
                        ...
                        <>
                            <div className="flex justify-between flex-row-reverse my-4">
                                ...
                                <h1 className=" text-[#000] text-[24px] my-1">دوره {data?.title}  </h1>
                            </div>
                            <p className="text-justify my-1">{data?.introduction}</p>
                            <p className="text-[#000]/50 text-justify my-1" >{data?.detail}</p>
                            {
                                data == null ? (
                            ...
                            <div className="grid grid-cols-2 gap-4 mt-4 w-[90%] mx-auto justify-between">
                                {
                                    data?.skills.map((skill: any, index: number) => (
                                        <SkillBox key={index} name={skill.name} />
                                    ))
                                }
                            </div>
            ...
            <div className="flex justify-center items-center my-8 w-[90%] mx-auto border-1 border-[#F89535] h-[85px] hover:cursor-pointer bg-[#F89535] text-white text-[24px] rounded-[12px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.5)]" onClick={purchaseCourse}>
            ...
            <Modal
                ...
                title="نوع دوره خود را انتخاب کنید"
            >
                <div className="flex w-[90%] mx-auto justify-around items-center">
                    <div className="flex items-center gap-2">
                        <label htmlFor="typeOfCourse_present">حضوری</label>
                        <input type="radio" name="typeOfCourse" id="typeOfCourse_present" value="present" />
                    </div>
                    <div className="flex items-center gap-2">
                        <label htmlFor="typeOfCourse_absence">غیر حضوری</label>
                        <input type="radio" name="typeOfCourse" id="typeOfCourse_absence" value="absence" />
                    </div>
                </div>

                <div className="flex justify-center my-4 border-1 border-[#F89535] bg-[#F89535] text-white h-[48px] rounded-[12px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.5)] hover:cursor-pointer items-center text-[24px]" >
                    <span>
                        ثبت و ادامه
                    </span>
                </div>
